                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <div class="btn-group mb-3 mr-3">
                                                          ...
                                                          <a href="{$metron['client_android']['v2rayng']['down']}" class="btn btn-pill btn-v2ray mb-4">&nbsp;&nbsp;<i class="metron-v2rayng text-white"></i>下载 V2rayNG 客户端</a>&nbsp;&nbsp;&nbsp;
                                                ...
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <div class="h6 pt-2">现在回到app首页，点右上角的的<code>“+  -->从剪切板导入”</code></div>
                                                        <div class="h6 pt-2">然后再点右上角的的<code>“...--->更新订阅”</code></div>
