                            ...
                            <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                <div class="d-flex align-items-center flex-wrap mr-2">
                                    <div class="d-flex flex-column">
                                        <h2 class="text-white font-weight-bold my-2 mr-5">WinX 使用教程</h2>
                                    </div>
                                </div>
                                                ...
                                                <div class="row p-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <div class="example-preview">
                                                            <p><code>WinX</code>平台的代理工具，支持 ss/v2ray（不支持 ssr），支持PAC分流。</p>
...
<!-- 开始 :: 内容段落 2 -->
                                                <div class="row p-5">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <!-- 结束 :: 段落标题 -->
                                                        <!-- 开始 :: 客户端下载按钮 -->
                                                        <a href="{$metron['client_windows']['winx']['down']}" class="btn btn-pill btn-v2ray copy-text" target="_blank">&nbsp;&nbsp;<i class="metron-v2rayng text-white"></i>下载 WinX 客户端</a>&nbsp;&nbsp;&nbsp;
                                                        <!-- 结束 :: 客户端下载按钮 -->
                                                        <div class="h6 pt-2">下载后，请务必解压，解压后打开<br /> <code>WinXray.exe</code></div>
                                                    </div>
                                                    <!-- 开始 :: 图片 -->
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="{$metron['assets_url']}/media/tutorial/windows/clashr/clashr.png" data-lightbox="images">
...
<!-- 开始 :: 内容段落 3 -->
                                                <div class="row p-5">
                                                    <div class="col-sm-12 col-md-12 col-lg-7 pb-5">
                                                        ...
                                                        <div class="h6 pt-2">粘贴到软件的<code>配置--添加订阅</code></div>
                                                        <div class="h6 pt-2">执行<code>更新订阅</code></div>
                                                        <div class="h6 pt-2">回到首页就可以开始使用了（如何切换线路：双击）</div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12 col-lg-5">
                                                        <a class="image-popup-no-margins" href="{$metron['assets_url']}/media/tutorial/windows/clashr/clashr.png" data-lightbox="images">
                                                        <img class="rounded-lg" style="width:100%" src="{$metron['assets_url']}/media/tutorial/windows/clashr/clashr.png"/></a>
